...
const GAME = (() => {
    ...
    function comp(g) {
        return [
            ...
            new Fase(g, 165, 140, 20,  54, 10, 165, 280, brown      , darkbrown , white, "fase9.png" , 2, 2),
            new Fase(g, 165, 140, 20,  54, 10, 165, 280, stdgray    , darkgray  , white, "fase10.png", 2, 2),
            new Fase(g, 160, 150, 25,  60, 10, 165, 300, red        , green     , black, "fase11.png", 3, 2),
            new Fase(g, 160, 150, 25,  60, 10, 165, 300, blue       , yellow    , white, "fase12.png", 3, 2),
            new Fase(g, 155, 160, 30,  66, 10, 165, 325, blue       , cyan      , white, "fase13.png", 4, 3),
            new Fase(g, 155, 160, 30,  66, 10, 165, 325, blue       , yellow    , white, "fase12.png", 4, 3),
            new Fase(g, 150, 170, 35,  72, 10, 160, 350, red        , green     , black, "fase11.png", 5, 3),
            new Fase(g, 150, 170, 35,  72, 10, 160, 350, stdgray    , darkgray  , white, "fase10.png", 5, 3),
            new Fase(g, 145, 180, 40,  76, 10, 160, 375, brown      , darkbrown , white, "fase9.png" , 6, 3),
